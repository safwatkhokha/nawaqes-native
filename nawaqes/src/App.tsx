...
// FloatingChatButton removed — chat feature disabled
                ...
                <div className="relative z-10 px-4 py-3.5">
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-3">
                    {[
                      ...
                      { label: t('home.messages'), value: chatUnreadCount, icon: <MessageCircle className="w-3.5 h-3.5" />, route: '/connect' },
                    ].map((stat) => (
                      <button
                        key={stat.label}
...
function GlobalUI() {
  ...
  // isChatApp check removed — chat feature disabled
      ...
      <AppProvider>
        ...
        <HashRouter>
          ...
          <Routes>
            ...
            {/* /connect — friends chat (1-on-1 messaging, inside PageLayout) */}
            <Route path="/connect" element={<RequireAuth><PageLayout><ConnectPage /></PageLayout></RequireAuth>} />
            <Route path="/messages" element={<RequireAuth><Navigate to="/connect" replace /></RequireAuth>} />
            <Route path="/chat-app" element={<RequireAuth><Navigate to="/connect" replace /></RequireAuth>} />
            ...
            <Route path="/channels/:id" element={<RequireAuth><ChannelsPage /></RequireAuth>} />
