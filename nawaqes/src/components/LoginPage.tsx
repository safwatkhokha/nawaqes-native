  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          href="https://huggingface.co/datasets/safwatkhokha/nawaqes-backup/resolve/main/nawaqes-native-v3.0.2.apk"
          download
        ...
        >
          ...
          <div className="text-start">
            <p className="text-white text-xs font-bold leading-tight">تطبيق نواقص v3.0.2 Native</p>
            <p className="text-white/60 text-[9px] leading-tight">APK — إصلاح خطأ RNSVGRect + يعمل بالكامل</p>
          </div>
        </a>
      </motion.div>
