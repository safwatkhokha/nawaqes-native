    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {/* Nawaqes Unified App APK (v1.3.0) */}
          <a
            href="https://huggingface.co/datasets/safwatkhokha/nawaqes-backup/resolve/main/nawaqes-v1.3.0.apk"
            download
          ...
          >
            ...
            <div className="text-start">
              ...
              <p className="text-white text-xs font-bold leading-tight">APK · v1.3.0</p>
              <p className="text-white/50 text-[8px] leading-tight">تطبيق موحّد</p>
            </div>
          </a>
