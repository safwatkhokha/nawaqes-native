...
import { Home, PlusCircle, MessageCircle, Bell, Users, Megaphone, ShoppingBag, Video, UtensilsCrossed } from 'lucide-react';
...
export const MobileBottomNav: React.FC = () => {
  ...
  const hiddenRoutes = ['/livestream', '/live-stream', '/messages', '/chat-app', '/market-live'];
