...
import {
  Mail, Lock, User, Eye, EyeOff, ShieldCheck, KeyRound, Phone, Calendar,
  Check, X, Sparkles, AlertCircle, Clock, Loader2, Zap,
  TrendingUp, ArrowRight, ArrowLeft, CheckCircle2, XCircle, Download, Smartphone,
} from 'lucide-react';
  ...
  const renderRegisterForm = () => (
    ...
    >
      ...
      >
        ...
        <div className="relative">
          <Calendar className={`absolute top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 ${dir === 'rtl' ? 'right-3' : 'left-3'} pointer-events-none z-10`} />
          <input
            type="date"
            ...
            className={`${inputCls(false)} [color-scheme:light] dark:[color-scheme:dark]`}
            required
            dir="ltr"
          />
        </div>
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 px-6 pb-6 flex flex-col items-center gap-3"
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {/* Nawaqes Main App APK */}
          <a
            href="https://huggingface.co/datasets/safwatkhokha/nawaqes-backup/resolve/main/nawaqes-v1.2.1.apk"
            download
          ...
          >
            ...
            <div className="text-start">
              <p className="text-white/60 text-[9px] leading-tight">تطبيق نواقص</p>
              <p className="text-white text-xs font-bold leading-tight">APK · v1.2.1</p>
              <p className="text-white/50 text-[8px] leading-tight">4.5 MB</p>
            </div>
          </a>

          {/* Nawaqes Chat App APK */}
          <a
            href="https://huggingface.co/datasets/safwatkhokha/nawaqes-backup/resolve/main/nawaqes-chat-v1.3.1.apk"
            download
            className="flex items-center gap-2.5 px-5 py-3 rounded-xl bg-white/10 backdrop-blur border border-white/20 hover:bg-white/20 transition-all active:scale-95"
            style={{ textDecoration: 'none' }}
          >
            <Download className="w-6 h-6 text-white" />
            <div className="text-start">
              <p className="text-white/60 text-[9px] leading-tight">تطبيق دردشة</p>
              <p className="text-white text-xs font-bold leading-tight">APK · v1.3.1</p>
              <p className="text-white/50 text-[8px] leading-tight">4.5 MB</p>
            </div>
          </a>
          ...
          >
            ...
            <div className="text-start">
              <p className="text-white/60 text-[9px] leading-tight">دليل</p>
              <p className="text-white text-xs font-bold leading-tight">التثبيت</p>
            </div>
          </a>
        </div>
      </motion.div>
