  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-1 flex-1 justify-center h-full">
        ...
        <button
          ...
          className={`h-full px-4 border-b-4 flex flex-col items-center justify-center gap-0.5 transition-all group ${
            location.pathname.startsWith('/market') && !location.pathname.startsWith('/market-live')
              ? 'border-orange-600 text-orange-600'
              : `border-transparent ${textMuted} hover:text-orange-600`
          }`}
        >
        ...
        <button
          ...
          className={`h-full px-4 border-b-4 flex flex-col items-center justify-center gap-0.5 transition-all group ${
            location.pathname === '/market-live'
              ? 'border-orange-600 text-orange-600'
              : `border-transparent ${textMuted} hover:text-orange-600`
          }`}
        >
          <Video className="w-7 h-7 group-hover:scale-110 transition-all" />
          <span className="text-[11px] font-bold">{t('navbar.live') || 'لايف'}</span>
        </button>
        <button
        ...
        >
          <Megaphone className="w-7 h-7 group-hover:scale-110 transition-all" />
      ...
      <div className="flex items-center gap-2 flex-1 justify-end">
        ...
        {/* Messages Button - hidden on mobile (in bottom nav) */}
        <button
