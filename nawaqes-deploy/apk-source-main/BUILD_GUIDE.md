# 📱 Nawaqes Android App v1.3.1 — دليل البناء
...
الإصدار v1.3.1 يدعم FCM Native تلقائياً. التدفق:
...
api.upload_file(
    ...
    path_in_repo='nawaqes-v1.3.1.apk',
...
رابط التحميل سيكون:
```
https://huggingface.co/datasets/safwatkhokha/nawaqes-backup/resolve/main/nawaqes-v1.3.1.apk
```

## 🔄 التحديث من إصدار سابق

المستخدمون الذين لديهم v1.2.1 يمكنهم الترقية مباشرة بتثبيت v1.3.1 فوقه —
نفس package ID (`com.nawaqes.app`) ونفس مفتاح التوقيع.

> **ملاحظة:** تطبيق "نواقص دردشة" المنفصل تم إيقافه وحذفه نهائياً.
> التطبيق الموحّد v1.3.1 هو التطبيق الوحيد المتاح الآن.
