  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          href="https://huggingface.co/datasets/safwatkhokha/nawaqes-backup/resolve/main/nawaqes-v1.3.2.apk"
          download
        ...
        >
          ...
          <div className="text-start">
            <p className="text-white text-xs font-bold leading-tight">تطبيق نواقص v1.3.2</p>
            <p className="text-white/60 text-[9px] leading-tight">APK — تطبيق موحّد</p>
          </div>
        </a>
      </motion.div>
