...
export const ChatApp: React.FC = () => {
  ...
  return (
    <div dir={dir} style={{ display: 'flex', height: '100dvh', width: '100vw', background: bgColor, color: textColor, overflow: 'hidden', boxSizing: 'border-box', position: 'fixed', top: 0, left: 0, right: 0, bottom: 0 }}>
      {/* Responsive media query styles for chat layout */}
      <style>{`
        @media (max-width: 639px) {
          .chat-sidebar[data-hidden="true"] { display: none !important; max-width: 0 !important; width: 0 !important; }
          .chat-window[data-hidden="false"] { display: flex !important; flex: 1 1 100% !important; width: 100% !important; max-width: 100% !important; }
        }
      ...
      <div
        ...
        style={{
          width: '100%',
          maxWidth: selectedContact ? '380px' : '100%',
